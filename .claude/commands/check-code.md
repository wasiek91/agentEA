...
→ Wymaga przeglądu: `.\run-code-reviewer.ps1`

**🔴 FAIL** (> 15 issues or security issues)
→ Wymaga refaktoryzacji + przeglądu

## Kiedy użyć pełnego Code Reviewer'a:

```powershell
.\run-code-reviewer.ps1 -Query "Przejrzyj $1"
```

Jeśli:
- Check znalazł security issues
- Check znalazł > 20 issues
- Chcesz głęboką analizę best practices
- Potrzebujesz ulepszeń architectural
