...
## Kiedy użyć Test Generator agenta:

```powershell
.\run-test-generator.ps1 -Query "Wygeneruj comprehensive testy dla $1"
```

Jeśli:
- Funkcja jest złożona (> 50 linii)
- Masz wiele edge cases
- Potrzebujesz performance tests
- Chcesz integration tests

## Integracja z workflow:

1. **Napisz feature**: `new_feature.py`
2. **Szybki test**: `/generate-tests feature_func new_feature.py`
3. **Przegląd**: `.\run-code-reviewer.ps1`
4. **Głębokie testy**: `.\run-test-generator.ps1`
