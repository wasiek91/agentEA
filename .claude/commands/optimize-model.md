...
**Deep Dive**: `.\run-rl-expert.ps1 -Query "Sharpe Ratio $2 - jak poprawić?"`
...
**Deep Dive**: `.\run-rl-expert.ps1 -Query "Drawdown control for $2"`
...
**Deep Dive**: `.\run-rl-expert.ps1 -Query "Improve win_rate to $2%"`
...
**Deep Dive**: `.\run-rl-expert.ps1 -Query "Training divergence - debug"`
...
**Deep Dive**: `.\run-rl-expert.ps1 -Query "Convergence issues - $2 steps"`
...
→ Wyświetla quick fixes
```

### Głęboka opcja:
```powershell
.\run-rl-expert.ps1
→ Interaktywna sesja z ekspertem
```
...
**Deep Dive Command**:
.\run-rl-expert.ps1 -Query "[recommendation]"
```
